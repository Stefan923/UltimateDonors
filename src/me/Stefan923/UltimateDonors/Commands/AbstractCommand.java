...
public abstract class AbstractCommand {
    ...
    protected abstract ReturnType runCommand(UltimateDonors instance, CommandSender sender, String... args) throws MissingPermissionException;

    protected abstract List<String> onTab(UltimateDonors instance, CommandSender sender, String... args);
